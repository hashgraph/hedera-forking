...
import "../user/HederaTokenService.sol";
...
contract TokenCreateContract is HederaTokenService, ExpiryHelper, KeyHelper {
    ...
    event HTSResponseCode(int responseCode, address token);
    ...
    function createFungibleTokenPublic(
        ...
        emit HTSResponseCode(responseCode, tokenAddress);

        if (responseCode != HederaResponseCodes.SUCCESS) {
            revert ("responseCode is NOT success");
        }
