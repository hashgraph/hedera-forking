...
echo "https://api.github.com/repos/hedera-forking/issues/$GITHUB_PR_NUMBER/comments"
curl -L \
  -X POST \
  -H "Authorization: Bearer $GITHUB_TOKEN" \
  "https://api.github.com/repos/hedera-forking/issues/$GITHUB_PR_NUMBER/comments" \
  -d "{\"body\":\"TEST CONTENT\"}"
